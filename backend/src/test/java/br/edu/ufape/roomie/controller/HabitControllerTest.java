...
@WebMvcTest(controllers = HabitController.class, excludeAutoConfiguration = UserDetailsServiceAutoConfiguration.class)
...
class HabitControllerTest {
    ...
    @Autowired
    private JacksonTester<HabitRequestDTO> habitRequestDTOTester;
    ...
    void getMyHabits_withHabits_returns200() throws Exception {
        ...
        HabitResponseDTO dto = new HabitResponseDTO(10L, "MORNING", List.of("Games"), List.of("Noturno"), List.of("Organizado"));
        when(studentRepository.findById(1L)).thenReturn(Optional.of(student));
    ...
    void saveHabits_validStudent_returns200() throws Exception {
        ...
        HabitResponseDTO responseDto = new HabitResponseDTO(10L, "AFTERNOON", List.of("Leitura"), List.of("Introvertido"), List.of("Organizado"));
        when(studentRepository.findById(1L)).thenReturn(Optional.of(student));
        when(habitService.createOrUpdateHabit(any(Student.class), any(HabitRequestDTO.class))).thenReturn(responseDto);
